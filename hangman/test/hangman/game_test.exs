defmodule GameTest do
  ...
  test "all letters are lowercase" do
    game = Game.new_game()
    letters_string = game.letters |> List.to_string()

    assert letters_string == letters_string |> String.downcase()
  end
  ...
  test "first occurence of letters is not already used" do
    game = Game.new_game()
  ...
  test "second occurence of letters is already used" do
    game = Game.new_game()
